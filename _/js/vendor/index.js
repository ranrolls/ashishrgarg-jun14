...
$( document ).on( "pagecreate", ".jqm-demos", function( event ) {
	...
	$( "#leftNav-link" ).on( "click", function() {
		page.find( "#leftNav:not(.jqm-panel-page-nav)" ).panel( "open" );
	});

//	Right navmenu panel
$( "#rightNav ul" ).listview();
$( "#rmc" ).on( "click", function() {
	// page.find( "#rightNav(.jqm-panel-page-nav)" ).panel( "close" );
	page.find( "#rightNav:not(.jqm-panel-page-nav)" ).panel( "open" );
});
	...
	popup.one( "popupbeforeposition", function() {
		...
		$.each( sources, function( idx, options ) {
			...
			collapsible
				...
				.on( "mouseleave collapsiblecollapse hover", function() {
					popup.popup( "reposition", { positionTo: "window" } );
				})
				.on( "mouseenter collapsibleexpand hover", function() {
...
$( document ).on( "pagecreate", function( e ) {
	...
	$( e.target ).delegate( ".jqm-view-source", "popupbeforeposition", function() {
		...
		// $("div.jqm-navmenu-panel").find( "div.ui-collapsible-content" ).css( "max-height",	 "0px" );
